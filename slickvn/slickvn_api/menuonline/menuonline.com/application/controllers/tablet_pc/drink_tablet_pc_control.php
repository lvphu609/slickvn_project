...
class Drink_tablet_pc_control extends CI_Controller {
    ...
    public function index($page = 'index'){
        ...
        $data['left_menu'] = '
            ...
            <div class="left_menu left_menu_active" data-url="'.$url.'index.php/tablet_pc/drink_tablet_pc_control?table='.$table_number.'&type=drink&kind=all&hot=all&search=">
        ...
        $data['food_kind'] = '
            <table class="table table-hover">
                <tr>
                    <td><a href="'.$url.'index.php/tablet_pc/drink_tablet_pc_control?res_id='.$res_id.'&table='.$table_number.'&type=drink&kind=all&hot=all&search=">Tất cả</a></td>
                </tr>
        ';
        ...
        if($result->hasNext()){          
            while($result->hasNext()){
                ...
                if($field['kind_type'] == 'drink'){
                    $data['food_kind'] .= '
                        <tr>
                            <td><a href="'.$url.'index.php/tablet_pc/drink_tablet_pc_control?res_id='.$res_id.'&table='.$table_number.'&type=drink&kind='.$field['kind_name'].'&hot=all&search=">'.$field['kind_name'].'</a></td>
                        </tr>
                    '; 
                }
